/**
    The FinalExam class determines the grade for a final exam.
 */

public class FinalExam extends GradedActivity
{
    private int numQuestions;   // Number of questions in the exam.
    ...
    public FinalExam(int questions, int missed)
    {
        ...
        // Call the inherited setScore method to set the
        // numeric score.
        setScore(numericScore);
    }

    /**
        The getPointsEach method returns the number of points
    ...
    /**
        The getNumMissed method returns the number of questions
        missed.
