...
public class Month
{
    ...
    public Month(int monthNum) throws InvalidMonthNumber
    {
        ...
        {
            throw new InvalidMonthNumber(monthNum);
        }
     ...
     */
    public Month(String monthStr) throws InvalidMonthName
    {
        if (monthStr.equalsIgnoreCase("January"))
            ...
            throw new InvalidMonthName(monthStr);
    }
    ...
    /**
        ...
        @param monthStr The month number, as a String
     */
    public void setMonthNumber(String monthStr) throws InvalidMonthName
    {
        if (monthStr.equalsIgnoreCase("January"))
            this.monthNumber = 1;
        else if (monthStr.equalsIgnoreCase("February"))
