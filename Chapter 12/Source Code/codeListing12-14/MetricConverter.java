...
{
    private JPanel panel;                       // A hold panel.
    ...
    /**
        The buildPanel method adds a label, text field, and three
        radio buttons to a panel.
     */
    ...
    private class RadioButtonListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            {
                result = Double.parseDouble(input) * 38370.0;
                convertTo = " inches.";
            }

            // Display the conversion.
            System.out.println(input + " kilometers is " + result + convertTo);
        }
    }

    /**
        The main method creates an instance of the MetricConverter class,
