...
public class ColorCheckBoxWindow extends JFrame
{
    ...
    private class CheckBoxListener implements ItemListener
    {
        public void itemStateChanged(ItemEvent e)
        {
            ...
            {
                // Is the yellow check box selection? If so, we
            ...
            else if (e.getSource() == redCheckBox)
            {
                ...
                if (redCheckBox.isSelected())
                {
                    ...
                    // foreground color for the label and the two
                    // check boxes to red.
    ...
    /**
        The main method creates an instance of the ColorCheckBoxWindow
