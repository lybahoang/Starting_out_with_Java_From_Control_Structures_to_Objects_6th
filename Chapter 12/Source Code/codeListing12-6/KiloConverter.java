...
/**
    ...
    enter a distance in kilometers. When the Calculate button is
    clicked, a dialog box is displayed with the distance converted
    to miles.
 */
...
public class KiloConverter extends JFrame
{
    ...
    {
        // Create a window by calling the superclass' constructor.
        super();

        // Set the window title.
        this.setTitle("Kilometer Converter");
    ...
    /**
        The buildPanel method adds label, a text field, and a
        button to a panel.
     */
    ...
    /**
        The CaclButtonListener class is an action listener class for
    ...
    private class CalcButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            // Convert the input text to miles.
