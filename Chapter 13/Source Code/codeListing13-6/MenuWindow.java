...
{
    private JLabel messageLabel;            // Display a message.
    ...
    private JCheckBoxMenuItem visibleItem;  // Makes text visible.
    ...
    public MenuWindow()
    {
        ...
        // Create the messageLabel lable.
        messageLabel = new JLabel("Use the Text menu to change my " +
            "color and make me invisible.", SwingConstants.CENTER);
    ...
    /**
        ...
        is generated when the user selects Exit from the
        File menu.
     */
